...
export const imageColorTool = {
    name: "ec_image_color",
    description: "EasyClick截图取色分析工具。分析指定坐标的颜色值，或根据颜色自动生成findImage/findImageByColor代码。也可以生成模板匹配策略和多分辨率适配方案。",
    inputSchema: {
        type: "object",
        properties: {
            action: {
 ...
 * 生成按颜色查找策略
 */
function generateFindByColorStrategy(args) {
    const tolerance = args.tolerance || 10;
    return {
 ...
 * 生成模板匹配策略
 */
function generateTemplateStrategy(args) {
    return {
 ...
 * 生成图像识别代码模板
 */
function generateImageRecognitionTemplate(args) {
 ...
 * 生成多分辨率适配方案
 */
function generateMultiResolutionPlan(args) {
...
//# sourceMappingURL=image-color.js.map