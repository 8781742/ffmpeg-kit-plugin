...
export const troubleshootTool = {
    ...
    description: "快速诊断 EasyClick 脚本的常见问题（脚本闪退、找不到控件、卡屏、权限问题、网络错误等），提供针对性修复建议。",
    inputSchema: {
        type: "object",
        properties: {
            problem: {
