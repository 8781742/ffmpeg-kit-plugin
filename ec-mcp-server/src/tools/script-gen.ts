...
import { SCRIPT_TEMPLATES, getTemplates } from "../knowledge/templates.js";
import { queryApi } from "../knowledge/ec-api-db.js";

export const scriptGenTool = {
  name: "ec_script_gen",
  description:
    "根据需求描述和场景类型，生成完整的 EasyClick 自动化脚本。可以选择模板类型（基础框架/游戏挂机/授权系统/云控通信），也可以自由描述需求来自定义生成。",
  inputSchema: {
    type: "object",
    properties: {
      template: {
