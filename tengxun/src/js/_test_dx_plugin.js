...
logi("=== FFmpegMerge DEX Plugin Test ===");
...
// 7. 测试合并
logi("[7] 测试合并...");
var output = "/sdcard/Download/merged_dx_test.mp4";
logi("合并: " + valid[0].substring(valid[0].lastIndexOf('/')+1) + " + " + valid[1].substring(valid[1].lastIndexOf('/')+1));
